...
static uint32_t get_sector(uint32_t address)
{
    ...
    if (address < 0x08100000U) return FLASH_SECTOR_11;

    if (address < 0x08104000U) return FLASH_SECTOR_12;
    if (address < 0x08108000U) return FLASH_SECTOR_13;
    if (address < 0x0810C000U) return FLASH_SECTOR_14;
    if (address < 0x08110000U) return FLASH_SECTOR_15;
    if (address < 0x08120000U) return FLASH_SECTOR_16;
    if (address < 0x08140000U) return FLASH_SECTOR_17;
    if (address < 0x08160000U) return FLASH_SECTOR_18;
    if (address < 0x08180000U) return FLASH_SECTOR_19;
    if (address < 0x081A0000U) return FLASH_SECTOR_20;
    if (address < 0x081C0000U) return FLASH_SECTOR_21;
    if (address < 0x081E0000U) return FLASH_SECTOR_22;
    if (address < 0x08200000U) return FLASH_SECTOR_23;
...
{
    const char *request =
        "GET /slot_b_signed.bin HTTP/1.1\r\n"
